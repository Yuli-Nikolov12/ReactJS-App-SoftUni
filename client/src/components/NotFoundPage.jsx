      ...
      <>
        <main className="min-h-full px-6 py-24 sm:py-32 lg:px-8">
            <div  className="text-center p-20 ">
                ...
                <h1 className={`mt-4 text-3xl font-bold tracking-tight text-gray-${mode=== false? "300" : "900"} sm:text-5xl`}>Page not found</h1>
                <p className={`mt-6 text-base leading-7 text-gray-${mode=== false? "300" : "900"}`}>Sorry, we couldn’t find the page you’re looking for.</p>
